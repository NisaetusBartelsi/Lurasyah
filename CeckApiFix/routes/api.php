...
Route::post('/email-forgot-pass', [ForgotPasswordAPIController::class, 'sendResetLinkEmail']);
Route::post('/token-link/{id}', [ForgotPasswordAPIController::class, 'showResetForm']);
Route::post('/form-reset-password', [ForgotPasswordAPIController::class, 'reset']);
