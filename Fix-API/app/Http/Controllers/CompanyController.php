...
class CompanyController extends Controller
{
    ...
    public function CreateAdmin(Request $request, $id)
    {
        ...
        if (!$user) {
            ...
            return response()->json(['atention' => 'You are not an admin']);
        }
    ...
    public function CompanyImages(Request $request, $id)
    {
        ...
        $updatedImages = ImagesCompany::where('company_id', $company_id)
            ->select('images')
            ->get();
    ...
    public function deleteCompanyImages(Request $request, $id)
    {
        ...
        $imageIds = explode(',', $id);
        $images = ImagesCompany::whereIn('id', $imageIds)->get();
    ...
    public function addcomment(Request $request, $id)
    {
        ...
        return response()->json(['comments' => $comments, 'value' => $count]);
    }
